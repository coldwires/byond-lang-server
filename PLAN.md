...
>
> Status: **M0–M10 complete · M11 at zero invented · ABI 0.31** · 1,709 tests ·
...
- ✅ `Dm.Core.Tests` + `Dm.Native.Tests` + `Dm.Lsp.Tests`, 38 tests at M0 and 1,709 today (1,631
